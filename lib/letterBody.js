...
const generateParagraphs = ({
  ...
  const industries = {
    ...
    tech: `I am impressed with quality engineering that ${company} has put forth to make it a leader in XXXX`,
  };
  ...
  return {
    ...
    role: roles[role],
    aboutMe: `${aboutMe} ${company} promotes a culture of collaboration and commitment to quality which is both why I’m happy to be considered and am confident I’d fit right in.`,
