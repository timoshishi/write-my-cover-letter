...
export const INDUSTRIES = {
  ...
  tech: 'I am impressed with the quality engineering that ${company} has put forth to make it a leader in XXXX and would love to face the unique and interesting challenges that your engineers encounter.',
  foodService:
  ...
  education:
    'As someone who currently works in the education of students in Full Stack development I understand the needs of students and believe that ${company} is making great efforts and progress in education with the transformational power of technology.',
  consulting:
